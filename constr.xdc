...
#Buttons
set_property PACKAGE_PIN U18 [get_ports btnC] ;# BTNC - RESET GLOBAL
set_property IOSTANDARD LVCMOS33 [get_ports btnC]
set_property PACKAGE_PIN T18 [get_ports btnU] ;# BTNU - PAUZA CRONOMETRU
set_property IOSTANDARD LVCMOS33 [get_ports btnU]
set_property PACKAGE_PIN W19 [get_ports btnL] ;# BTNL - stânga (set)
set_property IOSTANDARD LVCMOS33 [get_ports btnL]
set_property PACKAGE_PIN T17 [get_ports btnR] ;# BTNR - dreapta (increment)
set_property IOSTANDARD LVCMOS33 [get_ports btnR]
set_property PACKAGE_PIN U17 [get_ports btnD] ;# BTND - jos (toggle secundă ceas)
